        ...
        $.get(`/api/gamePlayer?id=${id}`, function (data) {
            ...
            if (data.code === 200) {
                ...
                let admin = `<select class="fieldSelector" onchange="updateAdminLevel(${player.uid})" id="AdminLevelValue">
                            <option ${(player.adminlevel === "0") ? 'selected' : ''} value="0">${levels.admin[0]}</option>
                            <option ${(player.adminlevel === "1") ? 'selected' : ''} value="1">${levels.admin[1]}</option>
                            <option ${(player.adminlevel === "2") ? 'selected' : ''} value="2">${levels.admin[2]}</option>
                        </select>`;

                let medic = `<select class="fieldSelector" onchange="updateMedicLevel(${player.uid})" id="MedicLevelValue">
                            <option ${(player.mediclevel === "0") ? 'selected' : ''} value="0">${levels.medic[0]}</option>
                            <option ${(player.mediclevel === "1") ? 'selected' : ''} value="1">${levels.medic[1]}</option>
                            <option ${(player.mediclevel === "2") ? 'selected' : ''} value="2">${levels.medic[2]}</option>
                            <option ${(player.mediclevel === "3") ? 'selected' : ''} value="3">${levels.medic[3]}</option>
                            <option ${(player.mediclevel === "4") ? 'selected' : ''} value="4">${levels.medic[4]}</option>
                            <option ${(player.mediclevel === "5") ? 'selected' : ''} value="5">${levels.medic[5]}</option>
                            <option ${(player.mediclevel === "6") ? 'selected' : ''} value="6">${levels.medic[6]}</option>
                            <option ${(player.mediclevel === "7") ? 'selected' : ''} value="7">${levels.medic[7]}</option>
                            <option ${(player.mediclevel === "8") ? 'selected' : ''} value="8">${levels.medic[8]}</option>
                            <option ${(player.mediclevel === "9") ? 'selected' : ''} value="9">${levels.medic[9]}</option>
                        </select>`;

                let police = `<select class="fieldSelector" onchange="updatePoliceLevel(${player.uid})" id="PoliceLevelValue">
                            <option ${(player.coplevel === "0") ? 'selected' : ''} value="0">${levels.police[0]}</option>
                            <option ${(player.coplevel === "1") ? 'selected' : ''} value="1">${levels.police[1]}</option>
                            <option ${(player.coplevel === "2") ? 'selected' : ''} value="2">${levels.police[2]}</option>
                            <option ${(player.coplevel === "3") ? 'selected' : ''} value="3">${levels.police[3]}</option>
                            <option ${(player.coplevel === "4") ? 'selected' : ''} value="4">${levels.police[4]}</option>
                            <option ${(player.coplevel === "5") ? 'selected' : ''} value="5">${levels.police[5]}</option>
                            <option ${(player.coplevel === "6") ? 'selected' : ''} value="6">${levels.police[6]}</option>
                            <option ${(player.coplevel === "7") ? 'selected' : ''} value="7">${levels.police[7]}</option>
                        </select>`;

                let police_department = `<select class="fieldSelector" onchange="updatePoliceDepartment(${player.uid})" id="PoliceDepartmentValue">
                            <option ${(player.copdept === "0") ? 'selected' : ''} value="0">${levels.police_department[0]}</option>
                            <option ${(player.copdept === "1") ? 'selected' : ''} value="1">${levels.police_department[1]}</option>
                            <option ${(player.copdept === "2") ? 'selected' : ''} value="2">${levels.police_department[2]}</option>
                            <option ${(player.copdept === "3") ? 'selected' : ''} value="3">${levels.police_department[3]}</option>
                            <option ${(player.copdept === "4") ? 'selected' : ''} value="4">${levels.police_department[4]}</option>
                            <option ${(player.copdept === "5") ? 'selected' : ''} value="5">${levels.police_department[5]}</option>
                            <option ${(player.copdept === "6") ? 'selected' : ''} value="6">${levels.police_department[6]}</option>
                            <option ${(player.copdept === "7") ? 'selected' : ''} value="7">${levels.police_department[7]}</option>
                        </select>`;

                let medic_department = `<select class="fieldSelector" onchange="updateMedicDepartment(${player.uid})" id="MedicDepartmentValue">
                            <option ${(player.medicdept === "0") ? 'selected' : ''} value="0">${levels.medic_department[0]}</option>
                            <option ${(player.medicdept === "1") ? 'selected' : ''} value="1">${levels.medic_department[1]}</option>
                            <option ${(player.medicdept === "2") ? 'selected' : ''} value="2">${levels.medic_department[2]}</option>
                        </select>`;
                ...
                let list = `<h2>${player.name}</h2>
                    ...
                    <p><b>Police Department: </b>${police_department}</p>
                    <p><b>Medic Level: </b>${medic}</p>
                    <p><b>Medic Department: </b>${medic_department}</p>
                    ...
                    <div class="btnGroup">
                        ...
                        <button onclick="getPlayerVehicles('${player.pid}')">View Player Vehicles</button>
