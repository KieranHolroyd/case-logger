    ...
    <div class="grid__col grid__col--1-of-6" style="box-shadow: 0 0 5px 0 rgba(0,0,0,0.2);">
        <div class="selectionPanel"
            ...
            <div class="reportTypes" id="TypeOfReportList">
                ...
                <button class="pickbtn tor submenuBtn" value="Player Report">Report</button>
                <button class="pickbtn tor submenuBtn" value="Tech Support">General Support</button>
                <button class="pickbtn tor submenuBtn" value="Teamspeak Tags">General Tags</button>
                <button class="pickbtn tor submenuBtn" value="Whitelisting">Whitelisting</button>
