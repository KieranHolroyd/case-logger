  ...
  <script>
    ...
    var userArray;
      ...
      $.get("api/getUserInfo", function(data){
        ...
        $('#moreMenu').delay(150).prepend("<a href='./'>Dashboard</a><a href='logger'>Case Logger</a><a href='suggestions'>Suggestion Box</a><a href='me'>My Stats</a><a href='guides'>Guides</a><a href='meetings'>Meetings</a><a href='logs'>Server Logs</a>");
