...
$stmt = $pdo->prepare("SELECT * FROM audit_log WHERE log_context = 'PD_EMS_COMMAND' ORDER BY id DESC LIMIT 500 OFFSET :off");
        ...
        <div id="staff" class="selectionPanel">
            ...
            foreach($logs as $log) {
                ...
                if ($log->logged_in_user !== null) {
                    ...
                    $liu = " ~ <a class='user' href='/staff/#staf{$log->logged_in_user}'>$logstaff</a>";
                }
